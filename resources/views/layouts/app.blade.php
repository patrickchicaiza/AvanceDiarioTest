                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li><a class="nav-link" href="{{ route('platforms.index') }}">Manage Platform</a></li>

                            <li><a class="nav-link" href="{{ route('forms.index') }}">Manage Form</a></li>

                            <li><a class="nav-link" href="{{ route('details.index') }}">Manage Detail</a></li>
